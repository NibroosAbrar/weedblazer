...
ser = serial.Serial('COM6', 9600)  # Adjust 'COM9' to your Arduino's port
...
model = DetectMultiBackend("C:/Users/Nibroos/OneDrive/Documents/yolov5 pkm/yolov5-master/best.pt", device=device)
        ...
        for det in pred:  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if x_center > 320:
                        if y_center > 240:
                            Sx = int(((630*(x_center))/640)*10)
                            Sy = int(((530*(y_center)/480))*10)
                            if Sx:
                                if Sy:
                                    inputX = '1'
                        if y_center < 240:
